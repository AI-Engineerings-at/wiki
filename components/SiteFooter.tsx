      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="border-t border-slate-800 mt-8 pt-8 text-center text-sm text-slate-500 space-y-3">
          <div className="flex justify-center gap-4 mb-3">
            <a href="https://github.com/AI-Engineering-at" target="_blank" rel="noopener noreferrer" className="hover:text-[#31F1A8] transition-colors" title="GitHub">
            ...
            <a href="https://www.youtube.com/@AI-Engineering-at" target="_blank" rel="noopener noreferrer" className="hover:text-[#31F1A8] transition-colors" title="YouTube">
