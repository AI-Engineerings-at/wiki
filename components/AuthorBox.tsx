...
export function AuthorBox() {
  ...
  return (
    <aside className="border border-slate-800 rounded-xl bg-slate-900/50 p-6 mt-12" aria-label={isEn ? 'About the author' : 'Über den Autor'}>
      <div className="flex items-start gap-4">
        ...
        <div>
          <p className="text-white font-bold text-sm">Jörg Fuchs</p>
          <p className="text-slate-500 text-xs mb-2">
            {isEn ? 'AI Engineer · Mechatronics · Austria' : 'AI Engineer · Mechatroniker · Österreich'}
          </p>
          ...
          <div className="flex gap-3 mt-3 text-xs">
            <a href="https://www.ai-engineering.at/ueber" className="text-[#31F1A8] hover:underline">
              {isEn ? 'About me' : 'Über mich'}
            </a>
            <a href="https://hub.ai-engineering.at" className="text-[#31F1A8] hover:underline">
              Hub
            </a>
            <span className="text-slate-600 ml-auto">
              {isEn ? 'Last reviewed: April 2026' : 'Zuletzt geprüft: April 2026'}
            </span>
          </div>
        </div>
      </div>
