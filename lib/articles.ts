...
const toolsArticles: Article[] = [
  ...
  { title: 'Team-Chat: Agent-Kommunikation', description: 'Polling, Webhooks, Nachrichten-Format, Team-Kommunikation.', href: '/tools/mattermost-agent', category: 'tools', categoryLabel: 'Tools', date: '2026-03-01' },
  ...
  { title: 'Model Selection Guide', description: 'Wähle das richtige AI-Modell für deinen Anwendungsfall — von Llama bis Mistral.', href: '/tools/model-selection', category: 'tools', categoryLabel: 'Tools', date: '2026-03-01' },
