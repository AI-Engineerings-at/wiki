...
Im Playbook01-Team ([@jim, @jim01, @lisa01, etc.](docs/tools/agents)) sind das **Mattermost Bots**, nicht Claude Code Sub-Agents. Sie kommunizieren ueber Mattermost Webhooks und Bridge-Services.

**Sub-Agents** = Claude Code, isolierter Context, Tool-kontrolliert
**Team Agents** = Mattermost Bots, Multi-Session Orchestration, Chat-basiert

Beides kann kombiniert werden: Sub-Agents kuennten zu Mattermost posten, Team-Agents koennen Claude Code aufrufen.
...
- [Mattermost Integration](/de/tools/mattermost) — Team Agent Communication
