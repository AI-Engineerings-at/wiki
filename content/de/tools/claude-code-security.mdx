...
date: "2026-03-21"
summary: "Umfassende Security-Referenz für Claude Code. Permission Modes, Sandbox Konfiguration, Hooks, CLAUDE.md Sicherheit, Enterprise Compliance und häufige Fehler."
tags: ["security", "claude-code", "permissions", "sandbox", "enterprise", "compliance"]
author: "AI Engineering"
image: /images/hero-2026-08/de/tools/claude-code-security.webp
---
...
**Erlaubt:** Read, Write, Edit, Glob, Grep
**Blockiert:** Bash, Gefährliche Operationen
...
**Erlaubt:** Alles außer ...
**Blockiert:** Gefährliche Bash-Patterns (rm -rf, sudo)
...
**Erlaubt:** Voller Bash-Zugriff, Root Commands
**Blockiert:** Einige Admin-Operationen
