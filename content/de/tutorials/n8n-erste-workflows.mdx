...
**Was macht er**: Formular-Submission → Text kategorisieren (Bug/Feature/Feedback) → Alert in Mattermost schreiben.

### Aufbau

```
Webhook (Form) → Ollama Classify → Mattermost Post
```
...
Falls du Mattermost nicht hast, nimm stattdessen "Send Email" oder "Slack".
...
Du solltest eine Mattermost-Nachricht mit "BUG" Kategorisierung bekommen.
