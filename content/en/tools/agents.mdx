...
image: /images/hero-2026-08/en/tools/agents.webp
---
...
The Playbook01 team ([Manager-Agent, Developer-Agent, Infrastructure-Agent, etc.](docs/tools/agents)) uses **Team-Chat Bots**, not Claude Code sub-agents. They communicate via Team-Chat webhooks and bridge services.

**Sub-agents** = Claude Code, isolated context, tool-controlled
**Team agents** = Team-Chat Bots, multi-session orchestration, chat-based
...
- [Team-Chat Integration](/en/tools/mattermost) — Team agent communication
