...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/en/security/self-hosted-sicherheit.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function SelfHostedSecurityPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/en/security/self-hosted-sicherheit.webp" alt={'Self-Hosted Security: The 6-Layer Model'} />
      {/* Hero Section */}
