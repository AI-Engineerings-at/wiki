...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/en/security/verschluesselung.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function EncryptionPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/en/security/verschluesselung.webp" alt={'Encryption: At Rest, In Transit, In Use'} />
      {/* Hero Section */}
