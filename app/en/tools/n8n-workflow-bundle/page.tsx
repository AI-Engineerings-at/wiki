...
@enduml`}
      ...
      <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm text-slate-600">
        <p>Related articles:{' '}
          <a href="/en/tools/n8n-fuer-anfaenger" className="text-blue-400 hover:text-blue-300">n8n for Beginners</a>
          {' · '}
          <a href="/en/tools/rag-guide" className="text-blue-400 hover:text-blue-300">RAG Guide</a>
        </p>
