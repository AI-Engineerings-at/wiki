      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mt-16 pt-8 border-t border-white/10">
          ...
          <ul className="space-y-2 text-sm text-white/50">
            <li><a href="https://code.claude.com/docs/en/overview" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Anthropic: Claude Code Overview</a> — Official documentation</li>
            <li><a href="https://code.claude.com/docs/en/memory" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Anthropic: Claude Code Memory</a> — CLAUDE.md and memory system</li>
