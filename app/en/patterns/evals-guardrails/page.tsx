...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/en/patterns/evals-guardrails.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function EvalsGuardrailsENPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/en/patterns/evals-guardrails.webp" alt={'Evals & Guardrails — Measuring and Securing LLM Quality'} />
      {/* Hero Section */}
