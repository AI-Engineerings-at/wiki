...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/en/patterns/ai-agent-digital-employee.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function AIAgentDigitalEmployeePage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/en/patterns/ai-agent-digital-employee.webp" alt={'AI Agent as Digital Employee — Patterns & Architecture'} />
      {/* Hero Section */}
