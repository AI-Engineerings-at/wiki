        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1">
            ...
            <p className="text-slate-300 mb-4">
              All templates you need: Art. 30 Records, DPIA, DPA Checklist, 
              EU AI Act Readiness Checklist and more.
            </p>
            <ul className="text-sm text-slate-400 space-y-1 mb-4">
              <li>✓ Art. 30 Processing Records (AI Edition)</li>
              <li>✓ DPIA for AI Systems</li>
              <li>✓ EU AI Act Checklist</li>
            </ul>
          </div>
          <div className="text-center">
            <div className="text-3xl font-black text-white mb-3">EUR 79</div>
            <a
