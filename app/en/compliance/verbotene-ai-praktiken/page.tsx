        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1">
            ...
            <p className="text-slate-300 mb-4">
              All templates included: EU AI Act Compliance Checklist, 
              Art. 30 Records, DPIA template and more.
            </p>
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-slate-500 line-through mb-3">EUR 129</div>
            <a 
