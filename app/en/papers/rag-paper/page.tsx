...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/en/papers/rag-paper.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
  alternates: alternatesFor('/en/papers/rag-paper'),
  title: "Retrieval-Augmented Generation (RAG) Paper Explained",
  description:
...
export default function RAGPaperPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/en/papers/rag-paper.webp" alt={'Retrieval-Augmented Generation (RAG) Paper Explained'} />
      {/* Hero Section */}
