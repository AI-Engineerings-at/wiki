...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/en/papers/attention-is-all-you-need.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function AttentionPaperPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/en/papers/attention-is-all-you-need.webp" alt={'Attention Is All You Need — Transformer Explained'} />
      {/* Hero Section */}
