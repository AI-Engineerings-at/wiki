...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/tools/docker-grundlagen.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
  alternates: alternatesFor('/tools/docker-grundlagen'),
  title: "Docker Grundlagen: Container, Compose & Swarm",
  description:
...
export default function DockerGrundlagenPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/tools/docker-grundlagen.webp" alt={'Docker Grundlagen: Container, Compose & Swarm'} />
      {/* Hero Section */}
