...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/tools/ai-stack-setup.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
  alternates: alternatesFor('/tools/ai-stack-setup'),
  title: "AI Stack Setup in 30 Minuten: Ollama + Open WebUI + Docker",
  description:
...
export default function AiStackSetupPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/tools/ai-stack-setup.webp" alt={'AI Stack Setup in 30 Minuten: Ollama + Open WebUI + Docker'} />
      {/* Hero Section */}
