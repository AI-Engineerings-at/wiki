...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/tools/model-selection.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function ModelSelectionPage() {
  return (
    <div className="space-y-8">
      <ArticleHero src="/images/hero-2026-08/de/tools/model-selection.webp" alt={'Model Selection Guide'} />
      <div>
...
OLLAMA_MODELS=/root/.ollama/models`}</code>
        ...
        <section className="mt-16 pt-8 border-t border-white/10">
          ...
          <ul className="space-y-2 text-sm text-white/50">
            ...
            <li><a href="https://arena.ai" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">LMSYS Chatbot Arena</a> — Community-basiertes Modell-Ranking</li>
          </ul>
        </section>
      </div>
    </div>
