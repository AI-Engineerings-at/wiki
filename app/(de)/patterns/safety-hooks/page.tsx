...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/patterns/safety-hooks.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function SafetyHooksPage() {
  return (
    <div className="space-y-8">
      <ArticleHero src="/images/hero-2026-08/de/patterns/safety-hooks.webp" alt={'Safety Hooks Pattern'} />
      <div>
