...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/papers/hierarchical-reasoning.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
  alternates: alternatesFor('/papers/hierarchical-reasoning'),
  title: "Hierarchical Reasoning Model (2025) — Rekurrente AI ohne Chain-of-Thought",
  description:
...
export default function HierarchicalReasoningPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/papers/hierarchical-reasoning.webp" alt={'Hierarchical Reasoning Model (2025) — Rekurrente AI ohne Chain-of-Thought'} />
      {/* Hero Section */}
