...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/papers/react-paper.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
  alternates: alternatesFor('/papers/react-paper'),
  title: "ReAct: Reasoning and Acting erklärt",
  description:
...
export default function ReActPaperPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/papers/react-paper.webp" alt={'ReAct: Reasoning and Acting erklärt'} />
      {/* Hero Section */}
