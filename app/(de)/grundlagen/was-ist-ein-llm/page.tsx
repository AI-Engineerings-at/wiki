...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/grundlagen/was-ist-ein-llm.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function WasIstEinLLMPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/grundlagen/was-ist-ein-llm.webp" alt={'Was ist ein LLM? Large Language Models erklärt'} />
      {/* Hero Section */}
