...
export const metadata: Metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/security/verschluesselung.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
  alternates: alternatesFor('/security/verschluesselung'),
  title: "Verschlüsselung: At Rest, In Transit, In Use",
  description:
...
export default function VerschlüsselungPage() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/security/verschluesselung.webp" alt={'Verschlüsselung: At Rest, In Transit, In Use'} />
      {/* Hero Section */}
