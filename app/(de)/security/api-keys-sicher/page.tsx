...
export const metadata = {
  openGraph: {
    type: 'article',
    images: [{ url: '/images/hero-2026-08/de/security/api-keys-sicher.webp', width: 1344, height: 768, type: 'image/webp' }],
  },
...
export default function ApiKeysSicher() {
  return (
    <div className="space-y-6">
      <ArticleHero src="/images/hero-2026-08/de/security/api-keys-sicher.webp" alt={'API Keys sicher speichern'} />
      <div>
